...
var admin = {
	...
	register: function(_mt) {
		mt = _mt;
		mt.core.app.get("/music/admin", admin.view);
	},
	...
	init: function() {
		...
		// API
		mt.core.app.post("/music/admin/getListMusic", admin.api_getListMusic);
		mt.core.app.post("/music/admin/save", admin.api_save);
